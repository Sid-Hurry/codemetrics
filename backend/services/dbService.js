...
const initializeDatabase = async () => {
  ...
  try {
    ...
    // 8. Create career_insights table
    const createCareerInsightsTableQuery = `
    ...
    `;
    await connection.query(createCareerInsightsTableQuery);
    console.log('✅ "career_insights" table verified.');
