...
export default function Dashboard({ addToast }) {
  ...
  return (
    <div>
      ...
      <div className="kpi-grid">
        <div className="kpi-card" onClick={() => navigate('/history')} style={{ cursor: 'pointer' }}>
        ...
        <div className="kpi-card" onClick={() => navigate('/compare')} style={{ cursor: 'pointer' }}>
          <div className="kpi-info">
        ...
        <div className="kpi-card" onClick={() => navigate('/favorites')} style={{ cursor: 'pointer' }}>
          <div className="kpi-info">
            ...
            {recentSearches.length > 0 ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                {recentSearches.map((item) => (
                  <div 
                    key={item.id}
                    onClick={() => navigate(`/app/search?q=${item.username}`)}
                    style={{ 
                      display: 'flex', 
                      alignItems: 'center', 
        ...
        <div>
          <div className="card" style={{ height: '100%' }}>
            <div className="card-header">
              ...
              <Link to="/history" style={{ display: 'flex', alignItems: 'center', gap: '4px', textDecoration: 'none', color: 'var(--accent-primary)', fontSize: '0.8rem', fontWeight: '600' }}>
                View all
              </Link>
            </div>
